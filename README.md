...
```bash
git clone https://github.com/yourusername/gyaan-deck.git
cd gyaan-deck
```
...
👉 Would you like me to also add **screenshots + usage GIFs** in the README (demo UI, before/after slides) to make it more visually engaging?
